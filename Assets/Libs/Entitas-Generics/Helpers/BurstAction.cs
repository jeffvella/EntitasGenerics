...
{
    // From https://github.com/jeffvella/UnityBurstFunctions
    ...
    public interface IBurstRefAction<T1, T2, T3> : IBurstOperation
    {
        void Execute(ref T1 arg1, T2 arg2, T3 arg3);
    }
    ...
    [BurstCompile]
    public struct BurstRefAction<TFunc, T1, T2, T3> : IJob
    where TFunc : struct, IBurstRefAction<T1, T2, T3>
    where T1 : unmanaged
    where T2 : struct
    where T3 : struct
    {
        ...
        public unsafe void Execute()
        {
            ...
            func.Execute(ref *Argument1Ptr, arg2, arg3);
        }

        public static unsafe void Run(TFunc func, ref T1 arg1, T2 arg2, T3 arg3)
        {
            new BurstRefAction<TFunc, T1, T2, T3>
            {
                FunctionPtr = UnsafeUtility.AddressOf(ref func),
                Argument1Ptr = (T1*)UnsafeUtility.AddressOf(ref arg1),
                Argument2Ptr = UnsafeUtility.AddressOf(ref arg2),
